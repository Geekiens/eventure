...
@Controller
public class UpdateNoteApiController implements UpdateNoteApi {
    @Autowired
    private NoteRepository noteRepository;

    private static final Logger log = LoggerFactory.getLogger(UpdateNoteApiController.class);
    ...
    public UpdateNoteApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Note> updateNote(@ApiParam(value = "Bearbeitete Notiz"  )  @Valid @RequestBody Note note) {
