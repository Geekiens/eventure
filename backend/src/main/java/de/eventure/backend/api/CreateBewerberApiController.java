...
@Controller
public class CreateBewerberApiController implements CreateBewerberApi {

    private static final Logger log = LoggerFactory.getLogger(CreateBewerberApiController.class);
    ...
    public CreateBewerberApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Bewerber> createBewerber(@ApiParam(value = "Bewerber, der hinzugefügt wird"  )  @Valid @RequestBody Bewerber bewerber) {
