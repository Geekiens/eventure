...
@Controller
public class GetPruefungenApiController implements GetPruefungenApi {

    private static final Logger log = LoggerFactory.getLogger(GetPruefungenApiController.class);
    ...
    public GetPruefungenApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<List<Pruefung>> getPruefungen() {
