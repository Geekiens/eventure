...
@Api(value = "updateBewerber", description = "the updateBewerber API")
public interface UpdateBewerberApi {

    @ApiOperation(value = "Bearbeitet einen Bewerber", nickname = "updateBewerber", notes = "", tags={ "admin", })
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Bewerber bearbeitet"),
        @ApiResponse(code = 400, message = "invalid input, object invalid"),
        @ApiResponse(code = 409, message = "an existing item already exists") })
    @RequestMapping(value = "/updateBewerber",
