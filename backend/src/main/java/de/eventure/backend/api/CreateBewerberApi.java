...
@Api(value = "createBewerber", description = "the createBewerber API")
public interface CreateBewerberApi {

    @ApiOperation(value = "Fügt einen neuen Bewerber hinzu", nickname = "createBewerber", notes = "", tags={ "admin", })
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Bewerber erstellt"),
        @ApiResponse(code = 400, message = "invalid input, object invalid"),
        @ApiResponse(code = 409, message = "an existing item already exists") })
    @RequestMapping(value = "/createBewerber",
