...
@Api(value = "deleteTest", description = "the deleteTest API")
public interface DeleteTestApi {

    @ApiOperation(value = "Test löschen", nickname = "deleteTest", notes = "Setzt einen Test auf inaktiv. Löschen ist Persistenzgründen nicht sinnvoll.", tags={ "admin", })
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Test"),
        @ApiResponse(code = 400, message = "invalid input, object invalid"),
        @ApiResponse(code = 409, message = "Test existiert nicht") })
