...
@Controller
public class GetBewerberByBenutzernameAPIController implements GetBewerberByBenutzernameAPI {
    ...
    public GetBewerberByBenutzernameAPIController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Bewerber> getBewerberByBenutzername(@PathParam("benutzername") String benutzername) {
