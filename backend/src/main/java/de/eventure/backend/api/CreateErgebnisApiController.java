...
@Controller
public class CreateErgebnisApiController implements CreateErgebnisApi {

    private static final Logger log = LoggerFactory.getLogger(CreateErgebnisApiController.class);
    ...
    @Autowired
    public CreateErgebnisApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Ergebnis> createErgebnis(@ApiParam(value = "Ergebnis, die hinzugefügt wird"  )  @Valid @RequestBody Ergebnis ergebnis) {
