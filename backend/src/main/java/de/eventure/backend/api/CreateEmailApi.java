...
@Api(value = "createEmail", description = "the createEmail API")
public interface CreateEmailApi {

    @ApiOperation(value = "Fügt eine neue Email hinzu", nickname = "createEmail", notes = "", tags={ "admin", })
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Email erstellt"),
